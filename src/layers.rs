...
pub type KanataLayers =
    Layers<'static, KEYS_IN_ROW, LAYER_COLUMNS, ACTUAL_NUM_LAYERS, &'static [&'static CustomAction]>;

type Row = [kanata_keyberon::action::Action<'static, &'static [&'static CustomAction]>; KEYS_IN_ROW];
